...
class TheWireCharacterDataModel extends Equatable {
  ...
  const TheWireCharacterDataModel({
    this.abstract,
    this.abstractSource,
    this.abstractText,
    this.abstractUrl,
  ...
  factory TheWireCharacterDataModel.fromMap(Map<String, dynamic> data) {
    return TheWireCharacterDataModel(
  ...
  /// `dart:convert`
  ///
  /// Parses the string and returns the resulting Json object as [TheWireCharacterDataModel].
  factory TheWireCharacterDataModel.fromJson(String data) {
    return TheWireCharacterDataModel.fromMap(
        json.decode(data) as Map<String, dynamic>);
  }

  /// `dart:convert`
  ///
  /// Converts [TheWireCharacterDataModel] to a JSON string.
  String toJson() => json.encode(toMap());

  TheWireCharacterDataModel copyWith({
    String? abstract,
